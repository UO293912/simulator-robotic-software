...
class TestsChallenges(unittest.TestCase):
    ...
    def get_correct_code(self):
        path = Path(__file__).resolve().parents[1] / "codes" / "challenge6"
    ...
    def test_correct(self):
        ...
        correct_robot = drawing.get_robot_challenge(6)
        ...
        # Comprobación
        code, circuit = drawing.probe(6, code, correct_code, robot, correct_robot)
        # Código correcto
