...
## Simulator for Linear Actuator, Mobile Robots and 3D Robotic Arm (using Arduino)
...
- 3D Robotic Arm, an articulated arm simulation controlled with Arduino code and visualized in a 3D environment.
...
## Binary downloads
Official binaries for the simulator can be found [here](https://github.com/gonzalezgarciacristian/simulator-robotic-software/releases).
...
# License
This program is distributed under the [GNU General Public License Version 3](https://github.com/gonzalezgarciacristian/simulator-robotic-software/blob/main/LICENSE)
